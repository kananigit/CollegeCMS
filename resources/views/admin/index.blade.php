...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/system/admin" class="logo">
      ...
      <span class="logo-mini"><b>O</b>CT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Oasis</b>College</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://imond.co.ke" target="_blank">Oasis College</a>.</strong> All rights
    reserved.
  </footer>
